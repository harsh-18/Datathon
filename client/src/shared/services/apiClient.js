...
async function fetchWithFallback(endpoint, fallbackData) {
  try {
    ...
    console.warn(`[KSP API] Endpoint ${endpoint} unreachable. Using fallback seed data.`);
  }
  return fallbackData;
}
...
export async function getCases(filters = {}) {
  ...
  if (filters.crimeType && filters.crimeType !== 'All Categories') {
...
export async function queryData(queryText) {
  try {
    ...
    console.warn('[KSP API] Query endpoint offline. Running fallback matching.');
  }
